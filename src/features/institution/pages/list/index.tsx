...
import {get as getInstitution, destroy as destroyInstitution} from "@/features/institution/services/institution";
...
const InstitutionList = () => {
    ...
    useEffect(() => {
        if(loadData) getInstitution<InstitutionType>({type: 'datatable'})
