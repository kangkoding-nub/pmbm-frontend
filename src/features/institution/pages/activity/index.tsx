...
import ActivityComponent from "@/features/institution/components/activity";
        ...
        <React.Fragment>
            ...
            <Content page="component">
                <Block>
                    ...
                    <PreviewCard>
                        <ActivityComponent institutionId={user?.institutionId} modal={modal} setModal={setModal}/>
                    </PreviewCard>
                </Block>
            </Content>
        </React.Fragment>
