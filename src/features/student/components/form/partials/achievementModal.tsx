...
import { store as storeAchievement, update as updateAchievement } from "@/features/student/services/achievement";
import type { StudentAchievementType } from "@/types";
import { CHAMP_ACHIEVEMENT_OPTIONS, LEVEL_ACHIEVEMENT_OPTIONS, TYPE_ACHIEVEMENT_OPTIONS } from "@/constants";
...
const AchievementModal = ({ modal, setModal, achievement, setAchievement, setLoadData }: PartialProps) => {
