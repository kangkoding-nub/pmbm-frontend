...
import { studentTreasurer } from "@/features/student/services/student";
import { sendWhatsAppRegistrationProof } from "@/features/student/services/registration";
import moment from "moment/moment";
import { Dropdown, DropdownItem, DropdownMenu, DropdownToggle, FormGroup, Label, Spinner } from "reactstrap";
import { useNavigate } from "react-router-dom";
import { toast } from "react-toastify";
import RegistrationProof from "@/features/student/pages/print/components/RegistrationProof";
...
import { GENDER_OPTIONS, STUDENT_STATUS } from "@/constants";
...
const StudentOperator = () => {
    ...
    const handlePrint = useCallback(async (userId: number | undefined) => {
        ...
        setLoading(userId)
        try {
        const personal = await getPersonal<StudentPersonalType>({ userId: userId }).then((resp) => {
