...
import { getYears, deleteYear } from "@/features/master/services";
...
const Major: React.FC = () => {
    ...
    const handleDestory = (id: number | undefined) => {
        setLoading(id);
        deleteYear(id)
    ...
    useEffect(() => {
        if (loadData) {
            getYears<YearType>({ type: 'datatable' })
        ...
        <React.Fragment>
            ...
            <Content page="component">
                <Block size="lg">
                    ...
                    <Partial modal={modal} setModal={setModal} data={year} setData={setYear} setLoadData={setLoadData} />
                </Block>
            </Content>
        </React.Fragment>
    );
