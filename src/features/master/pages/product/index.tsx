...
import { get as getProduct, destroy as destroyProduct } from "@/features/master/services/product";
import { useInstitutionContext } from "@/hooks/useInstitutionContext";
import { ButtonGroup, Spinner } from "reactstrap";
import { getGender, formatCurrency } from "@/utils";
...
const Product = () => {
    ...
    const Column: ColumnType<ProductType>[] = [
        ...
        {
            name: "Harga",
            selector: (row) => "Rp. " + formatCurrency(row.price),
            sortable: false,
        },
        {
            name: "JK",
        ...
        {
            name: "Program",
            selector: (row) => row.programId === 0 ? "Semua" : row.program?.name,
            sortable: false,
        },
        {
            name: "Boarding",
            selector: (row) => row.isBoarding === 1 ? row.boardingId === 0 ? "Semua" : row.boarding?.name : '',
            sortable: false,
        },
        {
            name: "Aksi",
